...
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/installed)
  ...
  foreach(_conf_file ${_conf_files})
    if (EXISTS ${openhrp3_SOURCE_DIR})
      ...
      message("sed -i s@${CATKIN_DEVEL_PREFIX}/share/OpenHRP-3.1@${openhrp3_PREFIX}/share/openhrp3/share/OpenHRP-3.1@g ${_conf_file}")
      execute_process(COMMAND sed -i s@${CATKIN_DEVEL_PREFIX}/share/OpenHRP-3.1@${openhrp3_PREFIX}/share/openhrp3/share/OpenHRP-3.1@g ${_conf_file})
    endif()
